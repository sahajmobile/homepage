    ...
    <main className="pt-32 pb-24 max-w-5xl mx-auto px-6">
      ...
      <section className="mb-12 text-center">
        ...
        <p className="mt-4 text-slate-300 text-sm md:text-base max-w-2xl mx-auto">
          ...
          Bangladesh access smartphones, credit, and new income opportunities.
        </p>
      </section>

      {/* Why Join Us */}
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-white mb-4">Why join us</h2>
        <div className="grid md:grid-cols-2 gap-5">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Work on real problems for riders, garment workers, students, and
              shopkeepers – people who are entering the digital economy for the
              first time through smartphone financing.
            </p>
          </div>
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
            <p className="font-semibold text-slate-100 mb-1">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Work at the intersection of mobile technology, alternative data,
              and embedded credit – alongside experienced founders and global
              fintech advisors.
            </p>
          </div>
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
      ...
      <section className="rounded-2xl border border-dashed border-slate-700 bg-slate-900/40 p-6">
        ...
        <p className="text-sm text-slate-300 leading-relaxed mb-3">
          We&apos;re growing thoughtfully. Formal job postings will appear here
          as we expand the team across operations, partnerships, risk, and
          product.
        </p>
        <p className="text-xs text-slate-400">
          Interested in working with SahajMobile? Send your CV and a short note
          about the kind of problems you want to solve to{' '}
