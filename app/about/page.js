    ...
    <main className="pt-32 pb-24 max-w-5xl mx-auto px-6">
      ...
      <section className="mb-12 text-center">
        ...
        <p className="mt-4 text-slate-300 text-sm md:text-base max-w-2xl mx-auto">
          Founded in 2023, SahajMobile is a Bangladesh-rooted fintech focused on
          expanding financial inclusion by making smartphone ownership simple,
      ...
      <section className="mb-12 grid md:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5">
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            ...
            Bangladesh – especially the unbanked and underbanked – by using EMI
            financing to create new digital credit histories and unlock income
            opportunities.
          </p>
        </div>
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5">
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            ...
            competing with them. By investing first in rails and underwriting,
            we help retailers sell more devices while building long-term
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-white mb-4">Founding Team</h2>
        <div className="grid md:grid-cols-3 gap-5">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
            ...
            <p className="text-slate-300 text-xs leading-relaxed">
              ...
              experience at a fintech real estate fund and Macquarie Group. UC
              Berkeley graduate.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
            ...
            <p className="text-slate-300 text-xs leading-relaxed">
              ...
              Services Ltd. Brings a strong track record of building and scaling
              successful businesses in Bangladesh, with deep on-the-ground
              relationships.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Feng Wang</h3>
            <p className="text-slate-300 text-xs leading-relaxed">
