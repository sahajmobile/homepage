    ...
    <main className="pt-32 pb-24 max-w-5xl mx-auto px-6">
      ...
      <section className="mb-10 text-center">
        ...
        <p className="mt-4 text-slate-300 text-sm md:text-base max-w-2xl mx-auto">
          Customer journeys, partner success stories, and updates as we build
          the rails for smartphone-led financial inclusion.
        </p>
      </section>
        ...
        {placeholderPosts.map((post, i) => (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[10px] text-slate-500">{post.status}</span>
            </div>
