          ...
          <Container>
            ...
            >
              ...
              <p className="mt-4 text-sm md:text-base text-slate-300 leading-relaxed">
                ...
                SahajMobile helps you get the phone you need today and pay over
                time.
              </p>
        ...
        <SectionWrapper className="pt-8">
          <Container>
            ...
            >
              ...
              <p>
                • Sometimes a reference or guarantor may be requested depending
                on your profile
              </p>
            </motion.div>
          </Container>
          ...
          <Container>
            ...
            >
              ...
              <div className="rounded-2xl border border-slate-700/60 bg-slate-950/80 p-5">
                ...
                <p className="mt-2 text-xs md:text-sm text-slate-300 leading-relaxed">
                  Weekly or monthly EMIs that match your real-life cash flow and
                  income patterns.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-slate-700/60 bg-slate-950/80 p-5">
                ...
                <p className="mt-2 text-xs md:text-sm text-slate-300">
                  On-time repayment builds a digital repayment history that may
                  unlock more financial products in the future.
                </p>
              </div>
            </motion.div>
          </Container>
